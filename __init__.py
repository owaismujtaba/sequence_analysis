...
class Alignment(object):
    ...
    def dump1(self, wrap=None, out=sys.stdout):
        i = self.r_pos
        j = self.q_pos
    ...
    def get_locations(self, wrap=None, out=sys.stdout):
        i = self.r_pos
        j = self.q_pos
        ...
        while q and r and m:
            ...
            seq_end = qpos
            ref_start = r_pre % (rpos + self.r_offset + 1)
        ...
        ###
        #return str(seq_start)+str(seq_end)+ str(ref_start)+ str(ref_end)
        seq_start = int(seq_start.split(' ')[-2])
        
        ref_start = int(ref_start.split(' ')[-2])
       
        return seq_start, seq_end, ref_start, ref_end
